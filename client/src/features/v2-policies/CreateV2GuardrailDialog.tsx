...
import { fetchV2Templates } from '../../api/v2-templates.js';
import type { V2Template } from '../../api/v2-templates.js';

interface CreateV2GuardrailDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onCreated: (policy: V2Policy) => void;
}

export function CreateV2GuardrailDialog({ isOpen, onClose, onCreated }: CreateV2GuardrailDialogProps) {
  ...
  }, [name, description, scopeType, selectedClusterIds, selectedNamespaceIds, selectedLabels, selectedTemplateId, onCreated, resetForm]);
      ...
      <VStack gap={3} padding={4}>
        ...
        <FormLayout>
          <TextInput
            ...
            value={name}
            onChange={setName}
            placeholder="e.g. DNS Access — Production Clusters"
            isRequired
          />
          <TextArea
            label="Description"
